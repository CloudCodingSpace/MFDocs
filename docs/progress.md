...
But some cool things *were* added like the offscreen render-target feature, loading complex models based on scene and node hierarchy and
binary serialization. In fact, some caching approaches were also done, like caching the pipeline, caching loaded textures in the material system, etc.

!!! Quote    
*Looking forward to making more progress in the next year (April 8, 2026 - April 8, 2027)*
<p align="right">— CloudCodingSpace</p>
